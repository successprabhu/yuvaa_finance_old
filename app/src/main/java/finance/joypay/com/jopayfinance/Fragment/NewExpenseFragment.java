...
public class NewExpenseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v.findViewById(R.id.btn_submit_addexpenses).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((DashBoardActivity) getActivity()).ShowMessage(Status.SUCCESS, "New Expense Debited");

...
public class AppToastMessage implements View.OnClickListener {
     ...
     * @param activity
     */
    private AppToastMessage(Activity activity) {
        contextWeakReference = new WeakReference<>(activity);
    }

    /**
     * Create AppToastMessage with activity reference
     *
     * @param activity
     * @return
     */
    public static AppToastMessage with(Activity activity) {
        AppToastMessage sneaker = new AppToastMessage(activity);
        setDefault();
        return sneaker;
    }
     ...
     * @return
     */
    public AppToastMessage setTitle(String title) {
        mTitle = title;
        return this;
    }
     ...
     * @return
     */
    public AppToastMessage setTitle(String title, int color) {
        mTitle = title;
        if (getContext() != null) {
            try {
     ...
     * @return
     */
    public AppToastMessage setMessage(String message) {
        mMessage = message;
        return this;
    }
     ...
     * @return
     */
    public AppToastMessage setMessage(String message, int color) {
        mMessage = message;
        if (getContext() != null) {
            try {
     ...
     * @return
     */
    public AppToastMessage setIcon(int icon) {
        mIconDrawable = null;
        mIcon = icon;
        return this;
    }
     ...
     * @return
     */
    public AppToastMessage setIcon(Drawable icon) {
        mIcon = DEFAULT_VALUE;
        mIconDrawable = icon;
        return this;
    }
     ...
     * @return
     */
    public AppToastMessage setIcon(int icon, boolean isCircular) {
        mIconDrawable = null;
        mIcon = icon;
     ...
     * @return
     */
    public AppToastMessage setIcon(Drawable icon, boolean isCircular) {
        mIcon = DEFAULT_VALUE;
        mIconDrawable = icon;
        mIsCircular = isCircular;
        return this;
    ...
    public AppToastMessage setIcon(int icon, int tintColor) {
        mIconDrawable = null;
        mIcon = icon;
        if (getContext() != null) {
            try {
    ...
    public AppToastMessage setIcon(Drawable icon, int tintColor) {
        mIcon = DEFAULT_VALUE;
        mIconDrawable = icon;
        if (getContext() != null) {
            try {
     ...
     * @return
     */
    public AppToastMessage setIcon(int icon, int tintColor, boolean isCircular) {
        mIconDrawable = null;
        mIcon = icon;
        mIsCircular = isCircular;
        if (getContext() != null) {
     ...
     * @return
     */
    public AppToastMessage setIcon(Drawable icon, int tintColor, boolean isCircular) {
        mIcon = DEFAULT_VALUE;
        mIconDrawable = icon;
        mIsCircular = isCircular;
        if (getContext() != null) {
     ...
     */
    public AppToastMessage setIconSize(int size) {
        mIconSize = size;
        return this;
    }
     ...
     * @return
     */
    public AppToastMessage autoHide(boolean autoHide) {
        mAutoHide = autoHide;
        return this;
    }
     ...
     * @return
     */
    public AppToastMessage setHeight(int height) {
        mHeight = height;
        return this;
    }
     ...
     * @return
     */
    public AppToastMessage setDuration(int duration) {
        mDuration = duration;
        return this;
    }
     ...
     * @return
     */
    public AppToastMessage setOnSneakerClickListener(OnSneakerClickListener listener) {
        mListener = listener;
        return this;
    }
     ...
     * @return
     */
    public AppToastMessage setTypeface(Typeface typeface) {
        mTypeFace = typeface;
        return this;
    }
     ...
     */
    public void Toast(int backgroundColor) {
        if (getContext() != null) {
            try {
     ...
     * Icons, background and text colors for this are not customizable
     */
    public AppToastMessage ToastError() {
     ...
     * Icons, background and text colors for this are not customizable
     */
    public AppToastMessage ToastSuccess() {
        mBackgroundColor = Color.parseColor("#1AB394");
        mTitleColor = Color.parseColor("#FFFFFF");
        mMessageColor = Color.parseColor("#FFFFFF");
        mIconColorFilterColor = Color.parseColor("#FFFFFF");
    ...
    private void ToastView() {
        ...
        if (!mMessage.isEmpty()) {
            ...
            if (!mTitle.isEmpty())
                tvMessage.setPadding(46, 0, 26, 10); // Bottom padding if there is title
            else

...
import finance.joypay.com.jopayfinance.Activity.RegisterActivity;
...
public class OtpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v.findViewById(R.id.btnsendOTP).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().onBackPressed();
            }
        });
        v.findViewById(R.id.f_otp_editphone).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((RegisterActivity) getActivity()).NavigateToFragment(RegisterFragment.newInstance("test", "Signup"));
            }
        });
        return v;
    }
